...
지침의 위치는 `.claude/rules/instruction-placement.md` 계약을 따른다. 요약: always-on 사실/빌드/위험 경계 → `AGENTS.md`·`CLAUDE.md`, 경로 한정 규칙 → `.claude/rules/`, 강제 차단 → `.claude/settings.json`·hooks, 긴 참고 문서 → `docs/**`.
