const ko = {
  ...
  workflowStep2Desc: "프로젝트 파일 → Nova 템플릿 → 기본값 순으로 최적 지시사항 자동 적용",
  ...
  guideStep5Detail: "완료된 태스크는 '검토 중' 상태가 됩니다. '승인'으로 수락하거나 '반려'로 피드백을 남기세요. Nova가 5가지 항목(기능성, 데이터 무결성, 설계 정합성, 코드 품질, 안정성)으로 자동 품질 검사를 수행합니다.",
  guideTipsTitle: "팁",
